<template>
  ...
  >
    ...
    <g>
      <path
        class="st0"
        d="M178.906,135.453C178.906,86.047,138.859,46,89.453,46C40.063,46,0,86.047,0,135.453
      s40.063,89.453,89.453,89.453C138.859,224.906,178.906,184.859,178.906,135.453z"
        style="fill: white"
      ></path>
      <path
        class="st0"
        d="M298.188,46c-49.406,0-89.469,40.047-89.469,89.453s40.063,89.453,89.469,89.453s89.438-40.047,89.438-89.453
      S347.594,46,298.188,46z"
        style="fill: white"
      ></path>
      <rect
        x="34.078"
      ...
      <polygon
        class="st0"
        points="374.859,319.797 374.859,394.406 512,466 512,248.188 	"
        style="fill: white"
      ></polygon>
    </g>
  </svg>
